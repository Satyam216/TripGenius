  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-72 h-72 bg-accent/5 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="glass-card p-8 sm:p-10 w-full max-w-md animate-fade-in relative">
        <div className="text-center mb-8">
          ...
          <p className="text-text-muted">Sign in to your TripGenius account</p>
        </div>
